...
public class RuleEngine<T> : BaseProbabilisticRuleEngine, Rubric.Probabilistic.Async.IRuleEngine<T>
    where T : class
{
  ...
  public RuleEngine(IRuleset<T> ruleset,
                    ...
                    ILogger logger = null)
      : this(ruleset.Rules, isParallel, uncaughtExceptionHandler, logger) { }
