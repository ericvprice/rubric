    ...
    where TOut : class
{
    ...
    IPostRuleBuilder<TIn, TOut> WithPredicate(Func<IEngineContext, TOut, Task<double>> predicate);
    ...
    /// <param name="predicate">The predicate function.</param>
    /// <returns>A fluent continuation.</returns>
    IPostRuleBuilder<TIn, TOut> WithPredicate(Func<IEngineContext, TOut, CancellationToken, Task<double>> predicate);
