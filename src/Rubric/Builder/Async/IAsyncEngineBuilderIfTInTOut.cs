    ...
    where TOut : class
{
  ...
  /// <summary>
  ///   Start building a named prerule.
  /// </summary>
  /// <param name="name">The name of the prerule.</param>
  /// <returns>A prerule builder.</returns>
  IAsyncPreRuleBuilder<TIn, TOut> WithAsyncPreRule(string name);
  
  /// <summary>
  ///   Add a prerule to this engine. 
  /// </summary>
  ...
  /// <summary>
  ///   Add an async prerule to this engine. 
  /// </summary>
  /// <param name="rule">The rule to add.</param>
  /// <returns>A fluent continuation.</returns>
  ...
  /// <summary>
  ///   Add multiple prerules to this engine. 
  /// </summary>
  ...
  /// <summary>
  ///   Add multiple async prerules to this engine. 
  /// </summary>
  /// <param name="rules">The rules to add.</param>
  /// <returns>A fluent continuation.</returns>
  ...
  /// <summary>
  ///   Starting building an async postrule by name. 
  /// </summary>
  ...
  /// <summary>
  ///   Add an async postrule to this engine. 
  /// </summary>
  /// <param name="rule">The rule to add.</param>
  /// <returns>A fluent continuation.</returns>
  ...
  /// <summary>
  ///   Add multiple postrules to this engine. 
  /// </summary>
  /// <param name="rules">The rules to add.</param>
  /// <returns>A fluent continuation.</returns>
  ...
  /// <summary>
  ///   Add multiple async postrule to this engine. 
  /// </summary>
  /// <param name="rules">The rules to add.</param>
  /// <returns>A fluent continuation.</returns>
