...
namespace RulesEngine.Rules
{
    public static class RuleExtensionMethods
    {
        ...
        public static IAsyncPreRule<TIn> WrapAsync<TIn>(this IPreRule<TIn> syncRule) => new AsyncPreRuleWrapper<TIn>(syncRule);
        ...
        /// <returns>An async wrapper for this rule.</returns>
        public static IAsyncPostRule<TOut> WrapAsync<TOut>(this IPostRule<TOut> syncRule) => new AsyncPostRuleWrapper<TOut>(syncRule);
        ...
        /// <returns>An async wrapper for this rule.</returns>
        public static IAsyncRule<TIn, TOut> WrapAsync<TIn, TOut>(this IRule<TIn, TOut> syncRule) => new AsyncRuleWrapper<TIn, TOut>(syncRule);
