...
namespace RulesEngine.Rules.Async
{
    ...
    public interface IAsyncRule<in TIn, in TOut> : IDependency
    {
        /// <summary>
        ...
        Task<bool> DoesApply(IEngineContext context, TIn input, TOut output);
    ...
    public interface IAsyncRule<in T> : IDependency
    {
        ...
        /// <param name="output">The output object.</param>
        /// <returns>An awaitable task returning whether this rule should apply.</returns>
        Task<bool> DoesApply(IEngineContext context, T input);
        ...
        /// <param name="output">The output object.</param>
        /// <returns>An awaitable task.</returns>
        Task Apply(IEngineContext context, T input);
    }
}