  ...
  where TOut : class
{
  ...
  /// <inheritdoc />
  public IPostRuleBuilder<TIn, TOut> WithPredicate(Func<IEngineContext, TOut, Task<bool>> predicate)
  {
    if (predicate == null)
  ...
  /// <inheritdoc />
  public IPostRuleBuilder<TIn, TOut> WithPredicate(Func<IEngineContext, TOut, CancellationToken, Task<bool>> predicate)
  {
