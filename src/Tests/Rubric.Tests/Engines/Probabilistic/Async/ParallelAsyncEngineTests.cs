...
public class ParallelAsyncEngineTests
{
  ...
  public async Task WrapApplyAsyncException()
  {
    var engine = new RuleEngine<TestInput, TestOutput>(
        null,
        new [] { new TestExceptionRule(false) },
        null)
    {
      IsParallel = true
    };
  ...
  public async Task WrapDoesApplyAsyncException()
  {
    var engine = new RuleEngine<TestInput, TestOutput>(
        null,
        new [] { new TestExceptionRule(true) },
        null)
    {
      IsParallel = true
    };
  ...
  public async Task WrapPostApplyAsyncException()
  {
    var engine = new RuleEngine<TestInput, TestOutput>(
        null,
        null,
        new [] { new TestExceptionPostRule(false) })
    {
      IsParallel = true
    };
    var input = new TestInput();
  ...
  public async Task WrapPostDoesApplyAsyncException()
  {
    var engine = new RuleEngine<TestInput, TestOutput>(
        null,
        null,
        new [] { new TestExceptionPostRule(true) })
    {
      IsParallel = true
    };
    var input = new TestInput();
  ...
  {
    var engine = new RuleEngine<TestInput, TestOutput>(
        new [] { new TestExceptionPreRule(false) },
        null,
        null)
    {
      IsParallel = true
  ...
  {
    var engine = new RuleEngine<TestInput, TestOutput>(
        new [] { new TestExceptionPreRule(true) },
        null,
        null)
    {
      IsParallel = true
