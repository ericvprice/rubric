    ...
    public class AsyncPreRuleTests
    {
        ...
        public void LambdaConstructorException()
        {
            Assert.Throws<ArgumentNullException>(
                () => new LambdaAsyncPreRule<TestInput>("test", null, (c, i) => Task.CompletedTask));
            Assert.Throws<ArgumentNullException>(
                () => new LambdaAsyncPreRule<TestInput>("test", (c, i) => Task.FromResult(true), null));
            Assert.Throws<ArgumentNullException>(
                () => new LambdaAsyncPreRule<TestInput>(null, (c, i) => Task.FromResult(true),
                                                        (c, i) => Task.CompletedTask));
        }
