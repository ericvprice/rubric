...
namespace RulesEngine.Tests
{
    public class RuleTests
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new LambdaRule<TestInput, TestOutput>("test", null, (c, i, o) => { }));
            Assert.Throws<ArgumentNullException>(() => new LambdaRule<TestInput, TestOutput>("test", (c, i, o) => true, null));
            Assert.Throws<ArgumentException>(() => new LambdaRule<TestInput, TestOutput>(null, (c, i, o) => true, (c, i, o) => { }));
        }

        [Fact]
        public void LambdaConstructor()
        {
            var rule = new LambdaRule<TestInput, TestOutput>("test", (c, i, o) => true, (c, i, o) => { }, new[] { "dep1", "dep2" }, new[] { "prv1", "prv2" });
