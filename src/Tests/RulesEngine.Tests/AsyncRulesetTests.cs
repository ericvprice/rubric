...
namespace RulesEngine.Tests
{
    public class AyncRulesetTests {
        ...
        public void Exceptions() {
            ...
            Assert.Throws<ArgumentNullException>(() => new AsyncRuleset<TestInput, TestOutput>().AddAsyncPostRule(null));
            Assert.Throws<ArgumentNullException>(() => new AsyncRuleset<TestInput, TestOutput>().AddAsyncPreRules(null));
            Assert.Throws<ArgumentNullException>(() => new AsyncRuleset<TestInput, TestOutput>().AddAsyncRules(null));
            Assert.Throws<ArgumentNullException>(() => new AsyncRuleset<TestInput, TestOutput>().AddAsyncPostRules(null));
        }
    }
}